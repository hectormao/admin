 ...
 */
public class PltUsuario extends RegistroTabla implements Usuario, java.io.Serializable {
	...
	public PltUsuario(long usuaIdn, String usuaLogin, String usuaNombre,
			String usuaCorreo, String usuaEstado, short usuaInteAute,
			String usuaClave, Date usuaFechClav, String audiUsuario,
	...
	public PltUsuario(long usuaIdn, String usuaLogin, String usuaNombre,
			...
			String audiChecksum, Set<PltUsuaRol> pltUsuaRols) {
		this.usuaIdn = usuaIdn;
		this.usuaLogin = usuaLogin;
		this.usuaNombre = usuaNombre;
		this.usuaCorreo = usuaCorreo;
